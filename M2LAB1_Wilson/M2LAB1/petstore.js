...
function mostPopularDays(week) {
	...
	/* An 9/19 Notes 
       first, eliminate null/empty immediately 
	   next, read each individual Weekday to get numbers out 
	   ...
	   */ 
	   ...
	   console.log("inside most popular days");
...
function testPopDays(){
	...
	//console.log(days); 
	var answer = mostPopularDays(days);
	console.log("Expected Wednesday, got " + answer);
	//console.log(answer);
